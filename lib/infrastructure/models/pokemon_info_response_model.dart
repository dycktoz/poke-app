...
//
//     final pokemonInfoResponseModel = pokemonInfoResponseModelFromJson(jsonString);

import 'dart:convert';

PokemonInfoResponseModel pokemonInfoResponseModelFromJson(String str) =>
    PokemonInfoResponseModel.fromJson(json.decode(str));

String pokemonInfoResponseModelToJson(PokemonInfoResponseModel data) =>
